            ...
            while (True):
                ...
                if choice == 1:
                    ...
                    if tableName == "emp":
                        ...
                        value = "insert into emp (empno,ename,job,gender,sal,comm,deptno) VALUES ({}, '{}', '{}', '{}', {} ,{}, {})".format(empno, ename, job, gender, sal, comm, deptno)
                        cur.execute(value)
                    ...
                    # search coding for student table.
                        ...
                        if option == 1:
                            studentRoll = int(input("Enter roll number of the student: "))
                            try:
            ...
            while (True):
                ...
                if choose == 1:
                    ...
                    for records in rec:
                        ...
                        dele = "delete from book where book_name = '{}'".format(bookName)
                        curr.execute(dele)
